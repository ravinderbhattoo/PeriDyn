"""
The `LinearSpringRepulsionModel` module contains definitions for linear repulsive models.
...
export LinearSpringRepulsionModel


"""
    LinearSpringRepulsionModel(stiffness::Float64, mat1::PeridynamicsMaterial, mat2::PeridynamicsMaterial; distanceX=5, max_neighs=50)
...
"""
function LinearSpringRepulsionModel(stifness, mat1::PeridynamicsMaterial, mat2::PeridynamicsMaterial; kwargs...)
    NonLinearSpringRepulsionModel(1, stifness, mat1::PeridynamicsMaterial, mat2::PeridynamicsMaterial; kwargs...)
end
...
"""
function LinearSpringRepulsionModel(stifness, mat1::PeridynamicsMaterial; kwargs...)
    NonLinearSpringRepulsionModel(1, stifness, mat1::PeridynamicsMaterial; kwargs...)
end
