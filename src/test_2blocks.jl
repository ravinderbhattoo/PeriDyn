...
mat_gen2 = GeneralMaterial(y2,v2,x2,x2[1,:]*0 .+ 1, 1000.0, 3.1, 0.5, max_neigh=200)
...
RM2 = SimpleRepulsionModel(2.0,1.0,block2,distanceX=2,max_neighs=200)
...
velocity_verlet!([env],1000,freq1=20,freq2=20,file_prefix="2blocks")
