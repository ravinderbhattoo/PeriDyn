...
function virgin_state(k)
    ...
    RM12 = LJRepulsionModel(alpha,epsilon,block1,block2, distanceX=2,max_neighs=200)
    RM11 = LJRepulsionModel(alpha,epsilon,block1, distanceX=2,max_neighs=200)
    RM22 = LJRepulsionModel(alpha,epsilon,block2, distanceX=2,max_neighs=200)
